...
SHEET_COLUMNS = ["THREAD ID", "EVENT TYPE", "EVENT NAME", "REHEARSAL DATE | TIME", "PERF DATE | TIME", "LOCATION",
                 "OTHER INFO", "REMUNATION", "STATUS"]

# Telegram user IDs allowed to control the bot via private DM (WY, WF, PH, Bran)
ADMIN_DM_USER_IDS = {1505249420, 362804048, 903855240, 1887174554}
